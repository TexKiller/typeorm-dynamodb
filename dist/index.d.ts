...
import { datasourceManager, DatasourceManagerOptions, getConnection, getCustomRepository, getRepository, close, open } from './driver/dynamo/managers/datasource-manager';
...
export { AddOptions, close, datasourceInitializer, datasourceManager, DatasourceManagerOptions, DynamoEntityManager, DynamoSchemaBuilder, BigNumberTransformer, DynamoRepository, getRepository, getConnection, getCustomRepository, GlobalSecondaryIndex, open, PagingAndSortingRepository, paramHelper, FindOptions, UpdateExpressionOptions, BeginsWith, Page, Sort, Order, Pageable, pageableRoutes, BatchWriteItem, YesNoIndicatorTransformer, getDocumentClient, DynamoClient, ScanOptions };
